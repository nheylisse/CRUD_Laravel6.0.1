    ...
    <div class="sa-page-body">
      ...
      <div class="sa-content-wrapper">
          ...
          <ol class="align-items-center sa-page-ribbon breadcrumb" aria-label="breadcrumb" role="navigation">
          	<li><span id="refresh" class="btn sa-ribbon-btn sa-theme-btn" data-action="resetWidgets"><i class="fa fa-refresh"></i></span></li>
          		<li class="breadcrumb-item"><a href="layouts.html">SmartAdmin Intel</a></li>
          				<li class="breadcrumb-item"><a href="layouts.html">App Layouts</a></li>
		...
		<div>
			<div class="">
				<div class="">
					<h1 class="page-title text-center well hidden-mobile">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<div class="well text-center well-layouts">
							...
							<span class="label label-default">.sa-fixed-navigation</span>
							<span class="label label-default">.container</span>
							<span class="label label-default">.sa-fixed-page-footer</span>
							<span class="label label-default">.sa-fixed-header</span>
							<span class="label label-default">.sa-fixed-ribbon</span>
							<span class="label label-default">.smart-rtl</span>
							<br>
							<br>	

							<img src="assets/img/layout-skins/layout-collapse.png" class="img-responsive center-block img-layouts">
						</div>
					</div>
					<div class="col-sm-6">
						<!-- your contents here -->
						<div class="well text-center well-layouts">
							<h5>
								...
								<small>Add the following class(s) to body tag <code>.sa-hidden-menu</code></small>
							</h5>
							<h5>
								<small>
									<i>
							...
							<br>
							<br>
							<img src="assets/img/layout-skins/layout-hidden.png" class="img-responsive center-block img-layouts">
						</div>
					</div>
					...
					<div class="col-sm-6">
						...
						<div class="well text-center well-layouts">
							<h5>
								...
								<small>Add the following class(s) to body tag <code>.sa-fixed-navigation .container</code></small>
							</h5>
							<h5>
								<small>
									<i>
							...
							<span class="label label-default">.sa-fixed-ribbon</span>
							<span class="label label-default">.smart-sa-rtl</span>
							<br>
							<br>
							<img src="assets/img/layout-skins/layout-menutop.png" class="img-responsive center-block img-layouts">
						</div>
					</div>
					<div class="col-sm-6">
						<!-- your contents here -->
						<div class="well text-center well-layouts">
							...
							<br>
							<br>
							<img src="assets/img/layout-skins/layout-collapse-minified.png" class="img-responsive center-block img-layouts">
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<div class="well text-center well-layouts">
							...
							<span class="label label-default">.container</span>
							<span class="label label-default">.sa-hidden-menu</span>
							<span class="label label-default">.sa-fixed-page-footer</span>
							<span class="label label-default">.sa-fixed-header</span>
							<span class="label label-default">.sa-fixed-ribbon</span>
							...
							<br>
							<br>
							<img src="assets/img/layout-skins/layout-rtl.png" class="img-responsive center-block img-layouts">
						</div>
					</div>
					<div class="col-sm-6">
						<!-- your contents here -->
						<div class="well text-center well-layouts">
							<h5>
								...
								<small>Add the following class(s) to body tag <code>.smart-rtl .sa-fixed-navigation</code></small>
							</h5>
							<h5>
								<small>
									<i>
							...
							<br>
							<br>
							<img src="assets/img/layout-skins/layout-rtl-menutop.png" class="img-responsive center-block img-layouts">
						</div>
					</div>
