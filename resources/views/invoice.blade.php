...
<head>
  ...
  <link rel="stylesheet" media="screen, print" href="assets/app/app.bundle.css">
	<link rel="stylesheet" type="text/css" href="assets/pages/invoice.css">
  ...
  <div class="sa-wrapper">
    ...
    <div class="sa-page-body">
      ...
      <div class="sa-content-wrapper">
          ...
          <ol class="align-items-center sa-page-ribbon breadcrumb" aria-label="breadcrumb" role="navigation">
          	<li><span id="refresh" class="btn sa-ribbon-btn sa-theme-btn" data-action="resetWidgets"><i class="fa fa-refresh"></i></span></li>
          		<li class="breadcrumb-item"><a href="javascript:void(0)">Miscellaneous</a></li>
          				<li class="breadcrumb-item"><a href="invoice.html">Invoice</a></li>
		...
		<div class="w-100 well no-padding">
			<!-- widget content -->
				...
				<div class="widget-body-toolbar">
					...
					<div class="row">
						...
						<div class="col-sm-8 text-align-right">
							...
							<div class="btn-group">
								<a href="javascript:void(0)" class="btn btn-sm sa-btn-primary"> <i class="fa fa-edit"></i> Edit </a>
							</div>

							<div class="btn-group">
								<a href="javascript:void(0)" class="btn btn-sm sa-btn-success"> <i class="fa fa-plus"></i> Create New </a>
							</div>
				...
				<div class="padding-10">
					...
					<div class="row">
						<div class="col-xl-9 col-md-8">
							<h4 class="text-medium">Rogers, Inc.</h4>
							<address>
