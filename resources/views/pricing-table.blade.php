...
<head>
  ...
  <link rel="stylesheet" media="screen, print" href="assets/app/app.bundle.css">
	<link rel="stylesheet" type="text/css" href="assets/pages/pricing-table.css">
          ...
          <ol class="align-items-center sa-page-ribbon breadcrumb" aria-label="breadcrumb" role="navigation">
          	<li><span id="refresh" class="btn sa-ribbon-btn sa-theme-btn" data-action="resetWidgets"><i class="fa fa-refresh"></i></span></li>
          		<li class="breadcrumb-item"><a href="javascript:void(0)">Miscellaneous</a></li>
          				<li class="breadcrumb-item"><a href="pricing-table.html">Pricing Tables</a></li>
				...
				<div class="row">
			        ...
			        <div class="col-12 col-sm-6 col-lg-3">
			            <div class="panel panel-success pricing-big">
			                ...
			                <div class="panel-footer text-align-center">
			                    <a href="javascript:void(0);" class="btn sa-btn-primary btn-block" role="button">Download <span> now!</span></a>
			                	<div>
			        ...
			        <div class="col-12 col-sm-6 col-lg-3">
			            <div class="panel panel-teal pricing-big">
			                ...
			                <div class="panel-footer text-align-center">
			                    <a href="javascript:void(0);" class="btn sa-btn-primary btn-block" role="button">Purchase <span>via Paypal</span></a>
			                	<div>
				...
				<div class="row">
			        ...
			        <div class="col-12 col-sm-6 col-lg-3">
			            <div class="panel panel-darken">
			                ...
			                <div class="panel-footer text-align-center">
			                    <a href="javascript:void(0);" class="btn sa-btn-success" role="button">Sign Up</a>
			        ...
			        <div class="col-12 col-sm-6 col-lg-3">
			            <div class="panel panel-green-light">
			                ...
			                <div class="panel-footer text-align-center">
			                    <a href="javascript:void(0);" class="btn sa-btn-success" role="button">Sign Up</a> 1 month FREE trial</div>
			            </div>
			        </div>		        
			        <div class="col-12 col-sm-6 col-lg-3">
			            <div class="panel panel-darken">
			        ...
			        <div class="col-12 col-sm-4 col-lg-2">
			            <div class="panel panel-orange">
			                ...
			                <div class="panel-footer no-padding">
			                    <a href="javascript:void(0);" class="btn bg-orange text-white btn-block no-border-radius" role="button">Sign Up</a>
			                </div>
			            </div>
			        </div>
			        <div class="col-12 col-sm-4 col-lg-2">
			            <div class="panel panel-purple">
			                ...
			                <div class="panel-footer no-padding">
			                    <a href="javascript:void(0);" class="btn bg-purple text-white btn-block no-border-radius" role="button">Sign Up</a>
			                </div>
			            </div>
			        </div>		       
			        <div class="col-12 col-sm-4 col-lg-2">
			            <div class="panel panel-green-light">
			                ...
			                <div class="panel-footer no-padding">
			                    <a href="javascript:void(0);" class="btn bg-green-light text-white btn-block no-border-radius" role="button">Sign Up</a>
			                </div>
			            </div>
			        </div>		        
			        <div class="col-12 col-sm-4 col-lg-2">
			            <div class="panel panel-blue">
			                ...
			                <div class="panel-footer no-padding">
			                    <a href="javascript:void(0);" class="btn bg-blue text-white btn-block no-border-radius" role="button">Sign Up</a>
			                </div>
			            </div>
			        </div>
			        <div class="col-12 col-sm-4 col-lg-2">
			            <div class="panel panel-red-light">
			                ...
			                <div class="panel-footer no-padding">
			                    <a href="javascript:void(0);" class="btn bg-red-light text-white btn-block no-border-radius" role="button">Sign Up</a>
			                </div>
			            </div>
			        </div>		        
			        <div class="col-12 col-sm-4 col-lg-2">
			            <div class="panel panel-pink">
			                ...
			                <div class="panel-footer no-padding">
			                    <a href="javascript:void(0);" class="btn bg-pink text-white btn-block no-border-radius" role="button">Sign Up</a>
			                </div>
			            </div>
			        </div>
