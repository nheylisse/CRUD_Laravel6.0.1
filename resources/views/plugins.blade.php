...
<head>
  <title>Plugins | Smart Admin 2.0</title>
  <meta charset="utf-8">
          ...
          <ol class="align-items-center sa-page-ribbon breadcrumb" aria-label="breadcrumb" role="navigation">
          	<li><span id="refresh" class="btn sa-ribbon-btn sa-theme-btn" data-action="resetWidgets"><i class="fa fa-refresh"></i></span></li>
          		<li class="breadcrumb-item"><a href="form-elements.html">Forms</a></li>
          				<li class="breadcrumb-item"><a href="plugins.html">Form Plugins</a></li>
	...
	<section id="widget-grid" class="">
		...
		<div class="row">
			...
			<article class="col-sm-12">
				...
				<div class="jarviswidget no-padding jarviswidget-color-blue-dark" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
					<!-- widget options:
					...
					<div>
						...
						<div class="widget-body">
							...
							<div class="px-3 pt-3">
								<table id="user" class="table table-bordered table-striped m-0" style="clear: both">
									<tbody>
										<tr>
						...
						<div class="widget-body">
							...
							<form>
								...
								<fieldset class="margin-top-10">
									...
									<div class="row">
										<div class="col-sm-6 slider-danger">
											<label><code>.slider .slider-danger</code></label>
											<input type="text" class="slider" id="sal" value="" 
											data-slider-min="10" 
										...
										<div class="col-sm-6 slider-success">
											<label><code>.slider .slider-success</code></label>
											<input type="text" class="slider" id="sa2" value="" 
											data-slider-min="10" 
											data-slider-max="1000" 
											data-slider-step="1" 
									...
									<div class="row">
										<div class="col-sm-6 slider-warning">
											<label><code>.slider .slider-warning</code></label>
											<input type="text" class="slider" id="sa3" value="" 
											data-slider-min="1" 
											data-slider-max="300"  
										...
										<div class="col-sm-6 slider-info">
											<label><code>.slider .slider-info</code></label>
											<input type="text" class="slider" id="sa4" value="" 
											data-slider-min="1" 
											data-slider-max="300"  
											data-slider-value="150" 
									...
									<div class="row">
										<div class="col-sm-12 slider-primary">
											<label><code>.slider .slider-primary</code></label>
											<input type="text" class="slider" id="sa5" value="" 
											data-slider-min="1" 
											data-slider-max="300"  
											data-slider-value="150" 
											data-slider-selection = "before"
									...
									<div class="row">
										...
										<div class="col-sm-12">
											<div class="form-group">
												...
												<input class="form-control tagsinput" value="Amsterdam,Washington,Sydney,Beijing,Cairo">
											</div>
										</div>
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<span class="input-group-append"><span class="input-group-text"><i class="fa fa-phone"></i></span></span>
										</div>
										<p class="note">
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<span class="input-group-append"><span class="input-group-text"><i class="fa fa-asterisk"></i></span></span>
										</div>
										<p class="note">
											Data format ***-***-***-***-***-***
										</p>
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<span class="input-group-append"><span class="input-group-text"><i class="fa fa-briefcase"></i></span></span>
										</div>
										<p class="note">
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			//pageSetUp();
			 ...
			 if($.fn.mask) {
			 	$("[data-mask]").each(function(){var e=$(this),t=e.attr("data-mask")||"error...",a=e.attr("data-mask-placeholder")||"X";e.mask(t,{placeholder:a}),e=null});
