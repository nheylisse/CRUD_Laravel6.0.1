...
<head>
  ...
  <link rel="stylesheet" media="screen, print" href="assets/app/app.bundle.css">
	<link rel="stylesheet" type="text/css" href="assets/pages/forum-post.css">
    ...
    <div class="sa-page-body">
      ...
      <div class="sa-content-wrapper">
          	...
          	<li><span id="refresh" class="btn sa-ribbon-btn sa-theme-btn" data-action="resetWidgets"><i class="fa fa-refresh"></i></span></li>
          		<li class="breadcrumb-item"><a href="javascript:void(0)">App Views</a></li>
          				<li class="breadcrumb-item"><a href="javascript:void(0)">Forum Layout</a></li>
          						<li class="breadcrumb-item"><a href="forum-post.html">Post View</a></li>
		...
		<div class="d-flex w-100 home-header">
			<div>
				<h1 class="page-header"><i class="fa-fw fa fa-puzzle-piece"></i> App Views <span>> Forum Layout > Post View</span></h1>				
			</div>
			<div class="ml-auto">
				<ul class="sa-sparks">
		...
		<div class="d-flex w-100">
			...
			<div class="well w-100">
				<table class="table table-striped table-forum">
					<thead>
						<tr>
							<th colspan="2"><a href="forum.html"> Projects </a> > <a href="forum-topic.html">Business Requirement Docs </a> > Nam quam nunc blandit vel </th>
						</tr>
					</thead>
					<tbody>
						<!-- Post -->
						<tr>
							<td class="text-center"><a href="profile.html"><img alt="" src="assets/img/flags/us.png"> &nbsp; <strong>John Doe</strong></a></td>
							<td>on <em>Jan 1, 2014 - 12:00am</em></td>
						</tr>
						<tr>
							<td class="text-center" style="width: 12%;">
							<div class="push-bit">
								<a href="profile.html"> <img src="assets/img/avatars/sunny.png" width="50" alt="avatar" class="online"> </a>
						...
						<!-- Post -->
						<tr>
							<td class="text-center"><a href="profile.html"><img alt="" src="assets/img/flags/es.png"> &nbsp; <strong>Sadi Orlaf</strong></a></td>
							<td>on <em>Jan 1, 2014 - 12:00am</em></td>
						</tr>
						<tr>
							<td class="text-center" style="width: 12%;">
							<div class="push-bit">
								<a href="profile.html"> <img src="assets/img/avatars/5.png" width="50" alt="avatar" class="offline"> </a>
							</div><small>473 Posts</small></td>
							<td>
							<p>
						...
						<!-- Post -->
						<tr>
							<td class="text-center"><a href="profile.html"><img alt="" src="assets/img/flags/us.png"> &nbsp; <strong>Me</strong></a></td>
							<td><em>Today</em></td>
						</tr>
						<tr>
							<td class="text-center" style="width: 12%;">
