...
<body class="   smart-style-0">
    ...
    <div class="sa-page-body">
      ...
      <div class="sa-content-wrapper">
          ...
          <ol class="align-items-center sa-page-ribbon breadcrumb" aria-label="breadcrumb" role="navigation">
          	<li><span id="refresh" class="btn sa-ribbon-btn sa-theme-btn" data-action="resetWidgets"><i class="fa fa-refresh"></i></span></li>
          		<li class="breadcrumb-item"><a href="form-elements.html">Forms</a></li>
          				<li class="breadcrumb-item"><a href="bootstrap-forms.html">Bootstrap Form Elements</a></li>
		...
		<div class="d-flex w-100 home-header">
			<div>
				<h1 class="page-header"><i class="fa fa-pencil-square-o fa-fw "></i> Forms  <span>> Bootstrap Form Elements</span></h1>				
			</div>
			<div class="ml-auto">
				<ul class="sa-sparks">
				...
				<div class="well">
					<div class="input-group">
						...
						<div class="input-group-append">
							<button class="btn sa-btn-primary" type="button">
									...
									<form class="form-horizontal">
										...
										<fieldset>
											...
											<div class="form-group row">
												...
												<div class="col-md-10">
													...
													<div class="form-check">
													  <input class="form-check-input" type="radio" value="" id="defaultRadio3">
											...
											<div class="form-group row">
												...
												<div class="col-md-10">
													<div class="form-check form-check-inline">
													  <input class="form-check-input" type="radio" value="" id="defaultRadio4">
													  <label class="form-check-label" for="defaultRadio4">
													    Radiobox 4
													  </label>
													</div>
													<div class="form-check form-check-inline">
													  <input class="form-check-input" type="radio" value="" id="defaultRadio5">
													  <label class="form-check-label" for="defaultRadio5">
													    Radiobox 5
													  </label>
													</div>
													<div class="form-check form-check-inline">
													  <input class="form-check-input" type="radio" value="" id="defaultRadio6">
										...
										<fieldset class="demo-switcher-1">
											...
											<!-- <span class="toggle-demo">
													<span>Styles: </span>
													<span class="btn-group justify-content-between1" role="group">
												...
												<div class="col-md-10">
													<div class="row">
														<div class="col-sm-12">
															...
															<div class="input-group">
																<input type="text" class="form-control" id="inlineFormInputGroup" placeholder="With switch">
																<div class="input-group-append">
																	<div class="input-group-text">
										...
										<div class="form-actions">
											<div class="row">
												<div class="col-md-12">
													...
													<button class="btn sa-btn-primary" type="submit">
							...
							<div>
								...
								<div class="widget-body">
									...
									<form>
										...
										<div class="form-actions">
											<div class="btn sa-btn-primary btn-lg">
												<i class="fa fa-save"></i>
												Submit
											</div>
										</div>
							...
							<div>
								...
								<div class="widget-body">
									...
									<form class="form-inline">
									  ...
									  <input type="text" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Enter email">
									  ...
									  <button type="submit" class="btn sa-btn-primary mb-2">Sign in</button>
									</form>
										...
										<fieldset>
											...
											<div class="form-group row">
												...
												<div class="col-md-10">
													...
													<div class="form-check">
													  <input class="form-check-input" type="checkbox" disabled="disabled" value="" id="default-check-1">
													  <label class="form-check-label" for="default-check-1">
													    Checkbox 1
													  </label>
													</div>
													<div class="form-check">
													  <input class="form-check-input" type="checkbox" disabled="disabled" value="" id="default-check-2">
													  <label class="form-check-label" for="default-check-2">
													    Checkbox 2
													  </label>
													</div>
													<div class="form-check">
													  <input class="form-check-input" type="checkbox" disabled="disabled" value="" id="default-check-3">
													  <label class="form-check-label" for="default-check-3">
													    Checkbox 3
													  </label>
													</div>
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-10">
													<div class="form-check form-check-inline">
													  <input class="form-check-input" type="checkbox" disabled="disabled" value="" id="default-check-4">
													  <label class="form-check-label" for="default-check-4">
													    Checkbox 4
													  </label>
													</div>
													<div class="form-check form-check-inline">
													  <input class="form-check-input" type="checkbox" disabled="disabled" value="" id="default-check-5">
													  <label class="form-check-label" for="default-check-5">
													    Checkbox 5
													  </label>
													</div>
													<div class="form-check form-check-inline">
													  <input class="form-check-input" type="checkbox" disabled="disabled" value="" id="default-check-6">
													  <label class="form-check-label" for="default-check-6">
													    Checkbox 6
													  </label>
													</div>
												</div>
										...
										<fieldset>
											...
											<div class="form-group row">
												...
												<div class="col-md-10">
													...
													<div class="form-check">
													  <input class="form-check-input" type="radio" disabled="disabled" value="" id="radio-1">
													  <label class="form-check-label" for="radio-1">
													    Radiobox 1
													  </label>
													</div>
													<div class="form-check">
													  <input class="form-check-input" type="radio" disabled="disabled" value="" id="radio-2">
													  <label class="form-check-label" for="radio-2">
													    Radiobox 2
													  </label>
													</div>
													<div class="form-check">
													  <input class="form-check-input" type="radio" disabled="disabled" value="" id="radio-3">
											...
											<div class="form-group row">
												...
												<div class="col-md-10">
													...
													<div class="form-check form-check-inline">
													  <input class="form-check-input" type="radio" disabled="disabled" value="" id="radio-4">
													  <label class="form-check-label" for="radio-4">
													    Radiobox 4
													  </label>
													</div>
													<div class="form-check form-check-inline">
													  <input class="form-check-input" type="radio" disabled="disabled" value="" id="radio-5">
													  <label class="form-check-label" for="radio-5">
													    Radiobox 5
													  </label>
													</div>
													<div class="form-check form-check-inline">
													  <input class="form-check-input" type="radio" disabled="disabled" value="" id="radio-6">
													...
													<div class="row">
														<div class="col-sm-12">
															...
															<div class="input-group">
																...
																<input type="text" class="form-control" disabled="disabled" id="inlineFormInputGroup" placeholder="Username">
															</div>
														</div>
													</div>
												</div>
													...
													<div class="row">
														<div class="col-sm-12">
															...
															<div class="input-group">
																...
																<input type="text" class="form-control" disabled="disabled" id="inlineFormInputGroup" placeholder="">
															</div>
														</div>
													</div>
												</div>
												...
												<div class="col-md-10">
													<div class="row">
														<div class="col-sm-12">
															...
															<div class="input-group">
																<input type="text" disabled="disabled" class="form-control" id="inlineFormInputGroup" placeholder="With switch">
																<div class="input-group-append">
																	<div class="input-group-text">
																		<span class="onoffswitch">
																			<input type="checkbox" name="start_interval" class="onoffswitch-checkbox" id="st4">
																			<label disabled="disabled" class="onoffswitch-label" for="st4"> 
																				<span class="onoffswitch-inner" data-swchon-text="YES" data-swchoff-text="NO"></span> 
																				<span class="onoffswitch-switch"></span> 
																			</label> 
																		</span>
															...
															<div class="input-group">
																<div class="input-group-prepend">
																	<div class="input-group-text">
																		<span class="radio">
																			<label>
																				<input disabled="disabled" type="radio" class="radiobox style-0" name="style-0a2">
																				<span> Left</span> 
																			</label>
																		</span>
																	</div>
																</div>
																<input type="text" disabled="disabled" class="form-control" id="inlineFormInputGroup" placeholder="">
																<div class="input-group-append">
																	<div class="input-group-text">
																		<span class="radio">
																			<label>
											...
											<div class="form-group row">
												...
												<div class="col-md-10">
													<div class="row">
														<div class="col-sm-12">
															<div class="input-group">
																<input class="form-control" disabled="disabled" id="appendbutton" type="text">
																<div class="input-group-append">
																	<button disabled="disabled" class="btn btn-default" type="button">Search</button>
																	<button disabled="disabled" class="btn btn-default" type="button">Options</button>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-md-10">
													<div class="row">
														<div class="col-sm-12">
															...
															<div class="input-group">
  <input type="text" disabled="disabled" class="form-control" aria-label="Text input with segmented dropdown button">
  <div class="input-group-append">
    <button disabled="disabled" type="button" class="btn btn-default">Action</button>
    <button  disabled="disabled" type="button" class="btn btn-default dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      <span class="sr-only">Toggle Dropdown</span>
    </button>
    <div class="dropdown-menu">
      <a class="dropdown-item" href="#">Action</a>
												...
												<div class="col-md-10">
													<div class="row">
														<div class="col-sm-12">
															...
															<div class="input-group mb-3">
  <div class="input-group-prepend">
    <button type="button" disabled="disabled" class="btn btn-default">Action</button>
    <button type="button" disabled="disabled" class="btn btn-default dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      <span class="sr-only">Toggle Dropdown</span>
    </button>
    <div class="dropdown-menu">
      <a class="dropdown-item" href="#">Action</a>
  ...
  <input type="text" disabled="disabled" class="form-control" aria-label="Text input with segmented dropdown button">
										...
										<div class="form-actions">
											<div class="row">
												<div class="col-md-12">
													<button class="btn sa-btn-primary" disabled="disabled" type="submit">
														<i class="fa fa-save"></i>
														Submit
													</button>
							...
							<div>
								...
								<div class="widget-body">
									...
									<form>
										...
										<div class="form-actions">
											<button class="btn sa-btn-primary btn-lg" disabled="disabled">
												<i class="fa fa-save"></i>
												Submit
											</button>
										</div>
						...
						<div class="jarviswidget" id="wid-id-5" data-widget-colorbutton="false" data-widget-editbutton="false">
							...
							<div>
								...
								<div class="widget-body">
									...
									<form class="form-inline">
									  <label class="sr-only" for="inlineFormInputName2">Name</label>
									  <input type="text" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Enter email" disabled="disabled">

									  <label class="sr-only" for="inlineFormInputGroupUsername2">Username</label>
									  <div class="input-group mb-2 mr-sm-2">
									    <input type="password" class="form-control" id="inlineFormInputGroupUsername2" placeholder="Password" disabled="disabled">
									  </div>

									  <div class="form-check mb-2 mr-sm-2">
									    <input class="form-check-input" type="checkbox" id="rem" disabled="disabled">
									    <label class="form-check-label" for="rem">
									      Remember me
									    </label>
									  </div>

									  <button type="submit" disabled="disabled" class="btn sa-btn-primary">
											Sign in
										</button>
									</form>
