...
<head>
  ...
  <link rel="stylesheet" media="screen, print" href="assets/app/app.bundle.css">
	<link rel="stylesheet" type="text/css" href="assets/pages/inbox.css">
      ...
      <div class="sa-content-wrapper">
          ...
          <ol class="align-items-center sa-page-ribbon breadcrumb" aria-label="breadcrumb" role="navigation">
          	<li><span id="refresh" class="btn sa-ribbon-btn sa-theme-btn" data-action="resetWidgets"><i class="fa fa-refresh"></i></span></li>
          		<li class="breadcrumb-item"><a href="inbox.html">Outlook</a></li>
		...
		<div class="inbox-nav-bar no-content-padding">
			...
			<h1 class="page-title text-blue-dark d-none d-lg-inline-block"><i class="fa fa-fw fa-inbox"></i> Inbox &nbsp;
				<span class="btn-group">
					<a href="#" data-toggle="dropdown" class="btn btn-default btn-xs dropdown-toggle"></a>
			...
			<div class="btn-group d-lg-none d-sm-inline-block">
				<button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
					Inbox
				</button>
				<ul class="dropdown-menu pull-left">
					<li>
						<a class="dropdown-item" href="javascript:void(0);" class="inbox-load">Inbox <i class="fa fa-check"></i></a>
					</li>
					<li>
			...
			<a href="javascript:void(0);" id="compose-mail-mini" class="btn btn-primary pull-right d-lg-none d-sm-block"> <strong><i class="fa fa-file fa-lg"></i></strong> </a>
		...
		<div id="inbox-content" class="inbox-body no-content-padding">
			...
			<div class="inbox-side-bar">
				...
				<h6> Folder <a href="javascript:void(0);" rel="tooltip" title="" data-placement="right" data-original-title="Refresh" class="pull-right text-darken"><i class="fa fa-refresh"></i></a></h6>
				...
				<h6> Quick Access <a href="javascript:void(0);" rel="tooltip" title="" data-placement="right" data-original-title="Add Another" class="pull-right text-darken"><i class="fa fa-plus"></i></a></h6>
				...
				<div class="air air-bottom inbox-space">
					...
					3.5GB of <strong>10GB</strong><a href="javascript:void(0);" rel="tooltip" title="" data-placement="top" data-original-title="Empty Spam" class="pull-right text-darken"><i class="fa fa-trash-o fa-lg"></i></a>
			...
			<div class="inbox-footer">
				...
				<div class="row">
					...
					<div class="col-xs-6 col-sm-11 text-right">
						<div class="text-blue inline-block">
							<i class="text-blue-light d-none d-md-inline-block">Last account activity <i class="fa fa-clock-o"></i> 52 mins ago |</i> Displaying <strong>44 of 259</strong>
						</div>
					</div>
  ...
  $(function () {
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			loadInbox();
			function loadInbox() {
				loadAjaxContent("ajax/email-list.html", $('#inbox-content > .table-wrap'))
			}
			...
			$("#compose-mail").click(function() {
				loadAjaxContent("ajax/email-compose.html", $('#inbox-content > .table-wrap'));
			})
