          ...
          <ol class="align-items-center sa-page-ribbon breadcrumb" aria-label="breadcrumb" role="navigation">
          	<li><span id="refresh" class="btn sa-ribbon-btn sa-theme-btn" data-action="resetWidgets"><i class="fa fa-refresh"></i></span></li>
          		<li class="breadcrumb-item"><a href="flot.html">Tables</a></li>
          				<li class="breadcrumb-item"><a href="table.html">Normal Tables</a></li>
			...
			<section id="widget-grid" class="">
				...
				<div class=" row">
					...
					<article class="col-12">
						...
						<div class="jarviswidget jarviswidget-color-blue-dark" id="wid-id-0" data-widget-editbutton="false">
							<header>
						...
						<!-- Widget ID (each widget will need unique ID)-->
						<div class="jarviswidget jarviswidget-color-darken no-padding" id="wid-id-1" data-widget-editbutton="false">
							<header>
								<div class="widget-header">	
					...
					<article class="col-xl-6">
						...
						<!-- Widget ID (each widget will need unique ID)-->
						<div class="jarviswidget jarviswidget-color-green-dark no-padding" id="wid-id-2" data-widget-editbutton="false">
							<header>
								<div class="widget-header">	
									<span class="widget-icon"> <i class="fa fa-table"></i> </span>
					...
					<article class="col-xl-6">
						...
						<!-- Widget ID (each widget will need unique ID)-->
						<div class="jarviswidget jarviswidget-color-green-light no-padding" id="wid-id-3" data-widget-editbutton="false">
							<header>
								<div class="widget-header">	
									<span class="widget-icon"> <i class="fa fa-table"></i> </span>
							...
							<div>
								...
								<div class="widget-body p-0">
									...
									<div class="alert alert-info m-0">
										...
										<i class="fa-fw fa fa-info"></i>
										Add custom colors to your TR and TD <code>&lt;tr&gt;</code> by adding <code>.table-success</code>, <code>.table-danger</code>, <code>.table-warning</code> and <code>.table-info</code> respectively
									</div>
									<div class="table-responsive">
				...
				<div class=" row">
					...
					<article class="col-12">
						...
						<!-- Widget ID (each widget will need unique ID)-->
						<div class="jarviswidget no-padding" id="wid-id-4" data-widget-editbutton="false">
							<header>
								<div class="widget-header">	
									<span class="widget-icon"> <i class="fa fa-table"></i> </span>
							...
							<div>
								...
								<div class="widget-body p-0">
									...
									<div class="table-responsive">
										...
										<table class="table table-bordered mb-0  table-striped table-condensed table-hover smart-form has-tickbox">
											<thead>
												<tr>
													<th>
