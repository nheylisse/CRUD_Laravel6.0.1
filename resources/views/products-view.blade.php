          ...
          <ol class="align-items-center sa-page-ribbon breadcrumb" aria-label="breadcrumb" role="navigation">
          	<li><span id="refresh" class="btn sa-ribbon-btn sa-theme-btn" data-action="resetWidgets"><i class="fa fa-refresh"></i></span></li>
          		<li class="breadcrumb-item"><a href="javascript:void(0)">E-Commerce</a></li>
          				<li class="breadcrumb-item"><a href="products-view.html">Products View</a></li>
		...
		<div class="d-flex w-100">
			...
			<section id="widget-grid" class="">
							...
							<div class="row">
									...
									<div class="product-info">
										<div class="row align-items-center">
											<div class="col"> 
												<a href="javascript:void(0);" class="btn sa-btn-success">Add to cart</a>
											</div>
					...
					<div class="col-sm-6 col-md-6 col-lg-6">
						...
						<div class="product-content product-wrap clearfix">
							<div class="row">
									...
									<div class="product-info">
										<div class="row align-items-center">
											<div class="col"> <a href="javascript:void(0);" class="btn sa-btn-success">Add to cart</a> </div>
											<div class="col text-right">
												<select class="barrating">
												  <option value=""></option>
												  <option value="1">1</option>
				...
				<div class="text-center">
					<p>
						<a href="javascript:void(0);" class="btn sa-btn-primary btn-lg">Load more <i class="fa fa-arrow-down"></i></a>
					</p>
				</div>
